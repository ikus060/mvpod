...
public final class Localization {
	...
	public static final String PREFERENCE_MP4CONVERTER_LOCATION = "PREFERENCE_MP4CONVERTER_EMPLACEMENT"; //$NON-NLS-1$
	...
	public static final String PREFERENCE_GENERAL_OPTION_GROUP = "PREFERENCE_GENERAL_OPTION_GROUP"; //$NON-NLS-1$
	...
	public static final String OPTIONS_MP4_MUXER = "OPTIONS_MP4_MUXER"; //$NON-NLS-1$
