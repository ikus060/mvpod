...
public final class Localization {
	...
	public static final String INPUTOUTPUT_INTERLACED = "INPUTOUTPUT_INTERLACED"; //$NON-NLS-1$
	public static final String INPUTOUTPUT_INTERLACE_OPTIONS = "INPUTOUTPUT_INTERLACE_OPTIONS"; //$NON-NLS-1$
	public static final String INPUTOUTPUT_DEINTERLACE = "INPUTOUTPUT_DEINTERLACE"; //$NON-NLS-1$
	public static final String INPUTOUTPUT_DEINTERLACE_METHOD = "INPUTOUTPUT_DEINTERLACE_METHOD"; //$NON-NLS-1$
	public static final String INPUTOUTPUT_DEINTERLACE_FILTER = "INPUTOUTPUT_DEINTERLACE_FILTER"; //$NON-NLS-1$
