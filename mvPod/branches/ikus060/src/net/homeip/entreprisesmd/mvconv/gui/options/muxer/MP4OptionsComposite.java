 ...
 * 
 */
public class MP4OptionsComposite extends MuxerOptionsInterface {
	...
	public static MuxerOptionsMapper getMapper() {
		return new MuxerOptionsMapper() {
			Muxer muxer = new MP4BoxMuxer();

			public MuxerOptionsInterface createInterface(Composite parent,
					int style) {
				return new MP4OptionsComposite(parent, style);
			}
	 ...
	 *            the style.
	 */
	public MP4OptionsComposite(Composite parent, int style) {
		super(parent, style);
	}
