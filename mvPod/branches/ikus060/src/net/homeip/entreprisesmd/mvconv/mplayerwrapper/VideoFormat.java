...
public class VideoFormat {
	...
	public static final VideoFormat FORMAT_DIVX = new VideoFormat( "FORMAT_DIVX" ); //$NON-NLS-1$
	...
	public static final VideoFormat FORMAT_H263 = new VideoFormat( "FORMAT_H263" ); //$NON-NLS-1$
	public static final VideoFormat FORMAT_H264 = new VideoFormat( "FORMAT_H264" ); //$NON-NLS-1$
	public static final VideoFormat FORMAT_H264_AVC = new VideoFormat( "FORMAT_H264_AVC" ); //$NON-NLS-1$
	...
	public static final VideoFormat FORMAT_MP4V = new VideoFormat( "FORMAT_MP4V" ); //$NON-NLS-1$
	public static final VideoFormat FORMAT_MPEG_XVID = new VideoFormat( "FORMAT_MPEG_XVID" ); //$NON-NLS-1$
	public static final VideoFormat FORMAT_MPEG_PES = new VideoFormat( "FORMAT_MPEG_PES" ); //$NON-NLS-1$
